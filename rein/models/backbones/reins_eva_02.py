...
class ReinsEVA2(EVA2):
    def __init__(self, reins_config=None, relations_config=None, **kwargs):
        super().__init__(**kwargs)
        self.reins: Reins = MODELS.build(reins_config)
        self.relations: Relations = MODELS.build(relations_config)

    def forward_features(self, x, batch_img_metas):
        B, C, H, W = x.shape
